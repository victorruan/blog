...
Vruan::$container->register('router',function(){return new \Klein\Klein();},true);
Vruan::$container->register('index',function(){return new \VictorRuan\app\ctrls\Index();});
Vruan::$container->register('lists',function(){return new \VictorRuan\app\ctrls\Lists();});
Vruan::$container->register('p',function(){return new \VictorRuan\app\ctrls\P();});
Vruan::$container->register('chat',function(){return new \VictorRuan\app\ctrls\Chat();});
Vruan::$container->register('login',function(){return new \VictorRuan\app\ctrls\Login();});
Vruan::$container->register('sf',function(){return new \VictorRuan\app\ctrls\Sf();});
